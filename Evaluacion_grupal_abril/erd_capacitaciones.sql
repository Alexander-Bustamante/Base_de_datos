...
CREATE TABLE IF NOT EXISTS `mydb`.`Evaluacion_final` (
  ...
  PRIMARY KEY (`id_Evaluacion`, `id_Tipo_evaluacion`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cursos` (
  ...
  PRIMARY KEY (`id_Curso`, `id_tipo_curso`, `id_modalidad`, `id_Evaluacion`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Inscripciones` (
  ...
  PRIMARY KEY (`id_Inscripcion`, `id_Usuario`, `id_Curso`),
...
CREATE INDEX `fk_Inscripciones_Cursos1_idx` ON `mydb`.`Inscripciones` (`id_Curso` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Asistencias` (
  ...
  `id_Usuario` INT NOT NULL,
  `id_Curso` INT NOT NULL,
  PRIMARY KEY (`id_Asistencia`, `id_tipo_asistencia`, `id_Usuario`, `id_Curso`),
  ...
  CONSTRAINT `fk_Asistencias_Usuarios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Asistencias_Cursos1`
    FOREIGN KEY (`id_Curso`)
    REFERENCES `mydb`.`Cursos` (`id_Curso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Asistencias_Cursos1_idx` ON `mydb`.`Asistencias` (`id_Curso` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Calificaciones` (
  ...
  `id_Evaluacion` INT NOT NULL,
  PRIMARY KEY (`id_calificacion`, `Usuarios_id_Usuario`, `id_Evaluacion`),
  CONSTRAINT `fk_Calificaciones_Usuarios1`
    FOREIGN KEY (`Usuarios_id_Usuario`)
    REFERENCES `mydb`.`Usuarios` (`id_Usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Calificaciones_Evaluacion_final1`
    FOREIGN KEY (`id_Evaluacion`)
    REFERENCES `mydb`.`Evaluacion_final` (`id_Evaluacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE INDEX `fk_Calificaciones_Usuarios1_idx` ON `mydb`.`Calificaciones` (`Usuarios_id_Usuario` ASC) VISIBLE;

CREATE INDEX `fk_Calificaciones_Evaluacion_final1_idx` ON `mydb`.`Calificaciones` (`id_Evaluacion` ASC) VISIBLE;
